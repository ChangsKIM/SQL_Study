...
ADD CONSTRAINT FK_EMP_POSITION FOREIGN KEY (POS_NO)
REFERENCES EMP_POSITION(POS_NO);

ALTER TABLE EMPLOYEE
ADD CONSTRAINT FK_EMP_DEPARTMENT FOREIGN KEY (DEPT_NO)
REFERENCES EMP_DEPARTMENT(DEPT_NO);
